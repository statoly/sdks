...
if TYPE_CHECKING:
    from .monitors.monitors_request_builder import MonitorsRequestBuilder

class StatolyClient(BaseRequestBuilder):
    """
    The main entry point of the SDK, exposes the configuration and the fluent API.
    """
    def __init__(self,request_adapter: RequestAdapter) -> None:
        """
        Instantiates a new StatolyClient and sets the default values.
    ...
    @property
    def monitors(self) -> MonitorsRequestBuilder:
        """
        The monitors property
        """
        from .monitors.monitors_request_builder import MonitorsRequestBuilder

        return MonitorsRequestBuilder(self.request_adapter, self.path_parameters)
